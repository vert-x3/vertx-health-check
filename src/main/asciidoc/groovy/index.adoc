...
[source, groovy]
----
def healthCheckHandler1 = HealthCheckHandler.create(vertx)
def healthCheckHandler2 = HealthCheckHandler.createWithHealthChecks(HealthChecks.create(vertx))
...
[source, groovy]
----
def healthCheckHandler = HealthCheckHandler.create(vertx)
