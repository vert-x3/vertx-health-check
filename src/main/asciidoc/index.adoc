...
[source, $lang]
----
{@link examples.HealthCheckExamples#pool(HealthCheckHandler)}
----
...
[source, $lang]
----
{@link examples.HealthCheckExamples#httpEndPoint(io.vertx.servicediscovery.ServiceDiscovery, HealthCheckHandler)}
----
